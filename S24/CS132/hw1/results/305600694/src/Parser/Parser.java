...
public class Parser {
    ...
    public void parseStmt(Enums.Token token) {
    ...
    public void parseList(Enums.Token token) {
        // S L | [\epsilon]
    ...
    public void parseExpr(Enums.Token token) {
        switch(consume(token)) {
            // [true | false] | ! E
            case TRUE:
            case FALSE:
    ...
    public Enums.Token consume(Enums.Token token) {
    ...
    public Enums.Token next_token() {
        return this.tokens.peek();
    }

    public Enums.State getState(Enums.Token token) {
        switch (token) {
            case IF:
            case ELSE:
            case WHILE:
