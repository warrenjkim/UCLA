...
\begin{proof}
    ...
    \bf{($\bm{\implies}$)}
    Suppose $R$ is a UFD. Let $r \in R$ and consider its unique factorization $r = p_1 \cdots p_n$,
    where $p_i$ is a distinct irreducible. Since $R$ is a UFD, irreducible elements are prime.
