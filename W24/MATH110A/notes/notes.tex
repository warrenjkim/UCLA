...
\newcounter{corcounter}[subsection]
\renewcommand{\thecorcounter}{\thesubsection.\arabic{corcounter}}

\newcounter{lemcounter}[subsection]
\renewcommand{\thelemcounter}{\thesubsection.\arabic{lemcounter}}

\newenvironment{definition}[1]{
\refstepcounter{defcounter}
\begin{tcolorbox}[title={Definition \thedefcounter: \text{ #1}}, colback=blue!5!white, colframe=black!75!blue]
}{ \end{tcolorbox} }

\newenvironment{theorem}[1]{
  \refstepcounter{thmcounter}
  \begin{tcolorbox}[title={Theorem \thethmcounter \text{ #1}}, colback=green!5!white, colframe=black!75!green]
}{ \end{tcolorbox} }

\newenvironment{corollary}[1]{
  \refstepcounter{corcounter}
  \begin{tcolorbox}[title={Corollary \thecorcounter \text{ #1}}]
}{ \end{tcolorbox} }

\newenvironment{lemma}[1]{
  \refstepcounter{lemcounter}
  \begin{tcolorbox}[title={Lemma \thelemcounter \text{ #1}}]
}{ \end{tcolorbox} }
...
\begin{proof}
    ...
    \bf{surjective}. Since $f$ is injective and surjective, $f$ is a \bf{bijection}. Therefore,
    $Frac(F) \simeq F$.
\end{proof}
\begin{center}
    \vspace{5em}
