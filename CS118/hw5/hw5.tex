    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \item
            \begin{enumerate}[label=\textit{(\roman*)}]
                \item
                    $
                    \text{DevRTT} = \frac{3}{4} (12) + \frac{3}{4} \cdot |120 - 130|
                    = 4 + 7.5
                    = 11.5 \text{ms}
                    $
                \item 
                    $
                    \text{EstimatedRTT} = \frac{7}{8} (130) + \frac{1}{8} (120)
                    = 113.75 + 15
                    = 128.75 \text{ms}
                    $
                \item 
                    $
                    \text{TimeoutInterval} = 128.75 + 4(11.5)
                    = 174.75 \text{ms}
                    $
            \end{enumerate}
        \item
            \begin{enumerate}[label=\textit{(\roman*)}]
                \item
                    $
                    \text{DevRTT} = \frac{3}{4} (12) + \frac{3}{4} \cdot |150 - 130|
                    = 4 + 15
                    = 19 \text{ms}
                    $
                \item 
                    $
                    \text{EstimatedRTT} = \frac{7}{8} (130) + \frac{1}{8} (150)
                    = 113.75 + 18.75
                    = 132.5 \text{ms}
                    $
                \item 
                    $
                    \text{TimeoutInterval} = 132.5 + 4(19)
                    = 208.5 \text{ms}
                    $
            \end{enumerate}
    \end{enumerate}
...
\begin{answer}{45em}
    ...
    \begin{enumerate}
        \item
            $\textsf{ReceiveWindow} \geq \log_{2}(200 \cdot 1 \times 10^6) = 28$ bits. \\
