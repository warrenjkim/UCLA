...
\subsubsection{Corollary: Issues}
...
ranging from having a sole ``true name'' to allowing multiple aliases for a single file. Decisions
around the concept of a ``true name'' and its attributes can influence how files are perceived and
...
\subsubsection{Corollary: Benefits and Issues}
...
\subsubsection{Corollary: Practicality}
...
even with strict ordering at the software level, the intended sequence of writes might be disrupted.
